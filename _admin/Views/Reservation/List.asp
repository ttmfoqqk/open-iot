										...
										<input type="hidden" name="action" value="<%=action%>">
											...
											<div class="form-group col-lg-12 col-md-12">
												...
												<div class="col-lg-6 col-md-6">
													<div class="input-daterange input-group">
														<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
														<input type="text" class="form-control" name="sUseDate" id="sUseDate" value="" />
														<span class="input-group-addon">to</span>
														<input type="text" class="form-control" name="eUseDate" id="eUseDate" value=""/>
													</div>
												</div>
												<div class="col-lg-4 col-md-4 hidden-xs hidden-sm">
													<button type="button" class="btn btn-sm btn-primary btn-alt" id="sToday">오늘</button>
											...
											<table class="table table-bordered" id="tabletools">
												...
												%>
													<tr>
														...
														<td><a href="<%=anchor%>" class="text-normal"><%=obj.Location%></a></td>
														<td><a href="<%=anchor%>" class="text-normal"><%=obj.Facilities%></a></td>
