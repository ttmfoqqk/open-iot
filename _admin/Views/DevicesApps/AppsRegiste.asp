                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body pt0 pb0">
                                        ...
                                        <input type="hidden" id="No" name="No" value="<%=Model.No%>">
                                            ...
                                            <div class="form-group">
                                                <label class="col-lg-2 col-md-3 control-label" for="">Apps명</label>
                                                <div class="col-lg-10 col-md-9">
                                                    <input type="text" class="form-control" id="Name" name="Name" value="<%=Model.Name%>" placeholder="Apps명">
                                                </div>
                                            </div>
                                            <!-- End .form-group  -->
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10 col-md-9">
                                                    <div class="col-lg-3 col-md-3 col-sm-6 text-center">
	                                                    <div style="height:120px;width:120px;margin:0px auto;">
	                                                    	<img style="height: 100%;width:0px;overflow:hidden;"><img src="<%=iif(IsNothing(Model.ImagesList) or Model.ImagesList="","../../images/bg_no_image.png","/upload/Apps/" &Model.ImagesList)%>" style="max-width:120px;max-height:120px;">
	                                                    </div>
	                                                    <br>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10 col-md-9">
                                                    <div class="col-lg-3 col-md-3 col-sm-6 text-center">
	                                                    <div style="height:120px;width:120px;margin:0px auto;">
	                                                    	<img style="height: 100%;width:0px;overflow:hidden;"><img src="<%=iif(IsNothing(Model.Images1),"../../images/bg_no_image.png","/upload/Apps/" &Model.Images1)%>" style="max-width:120px;max-height:120px;">
	                                                    </div>
	                                                    <br>
	                                                    <button type="button" class="add btn btn-default mr5 mb10" onclick="images_add($(this))">사진등록</button>
	                                                ...
	                                                <div class="col-lg-3 col-md-3 col-sm-6 text-center">
	                                                    <div style="height:120px;width:120px;margin:0px auto;">
	                                                    	<img style="height: 100%;width:0px;overflow:hidden;"><img src="<%=iif(IsNothing(Model.Images2),"../../images/bg_no_image.png","/upload/Apps/" &Model.Images2)%>" style="max-width:120px;max-height:120px;">
	                                                    </div>
	                                                    <br>
	                                                    <button type="button" class="add btn btn-default mr5 mb10" onclick="images_add($(this))">사진등록</button>
	                                                ...
	                                                <div class="col-lg-3 col-md-3 col-sm-6 text-center">
	                                                    <div style="height:120px;width:120px;margin:0px auto;">
	                                                    	<img style="height: 100%;width:0px;overflow:hidden;"><img src="<%=iif(IsNothing(Model.Images3),"../../images/bg_no_image.png","/upload/Apps/" &Model.Images3)%>" style="max-width:120px;max-height:120px;">
	                                                    </div>
	                                                    <br>
	                                                    <button type="button" class="add btn btn-default mr5 mb10" onclick="images_add($(this))">사진등록</button>
	                                                ...
	                                                <div class="col-lg-3 col-md-3 col-sm-6 text-center">
	                                                    <div style="height:120px;width:120px;margin:0px auto;">
	                                                    	<img style="height: 100%;width:0px;overflow:hidden;"><img src="<%=iif(IsNothing(Model.Images4),"../../images/bg_no_image.png","/upload/Apps/" &Model.Images4)%>" style="max-width:120px;max-height:120px;">
	                                                    </div>
	                                                    <br>
	                                                    <button type="button" class="add btn btn-default mr5 mb10" onclick="images_add($(this))">사진등록</button>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10 col-md-9">
                                                	...
                                                	<p class="form-control-static"><a href="/Utils/download.asp?pach=/upload/Apps/&file=<%=obj.Name%>"><%=obj.Name%></a> <button type="button" class="btn btn-xs btn-default ml10" onclick="del_file($(this),<%=obj.No%>)">삭제</button></p>
                                                	<%
                                                		Next
                                                	end if
                                                	%>
                                            ...
                                            <div class="form-group">
                                                <label class="col-lg-2 col-md-3  control-label" for="">관련 디바이스</label>
                                                <div class="col-lg-10 col-md-9">
                                                	<%
...
function reg_fm(){
	...
	if( !$.trim( $('#Name').val() ) ){
		alert('어플리케이션명을 입력해주세요');return false;
	}
	if( sContent1.length <= 0 ){
		alert('어플리케이션 요약설명을 입력해주세요');return false;
	}
	
	if( !$('#ImagesList').val() && !$('#ImagesList_old').val() ){
		alert('어플리케이션 리스트 이미지를 선택해주세요');return false;
	}
	...
	if( (!$('#images_files1').val() && !$('#images_files1_old').val()) && (!$('#images_files2').val() && !$('#images_files2_old').val()) && (!$('#images_files3').val() && !$('#images_files3_old').val()) && (!$('#images_files4').val() && !$('#images_files4_old').val()) ){
		alert('어플리케이션 이미지를 선택해주세요');return false;
	}
	
	if( sContent2.length <= 0 ){
		alert('APP 상세설명을 입력해주세요');return false;
	}
...
function del_file(obj,No){
	...
	$.ajax({
		url : "?controller=Apps&action=DelFile",
		type : "POST",
		data : {
			No : No,
			partial:'True'
...
function del_relation(obj,No){
	if( !confirm('관련 Apps를 삭제 하시겠습니까?') ){
		return false;
	}
	$.ajax({
		url : "?controller=Apps&action=DelRelation",
		type : "POST",
		data : {
			No : No,
			partial:'True'
...
function call_relation(obj){
	...
	$.ajax({
		url : "?controller=Devices&action=AjaxDevicesList&MenuNo="+menuNo+"&partial=True",
		type : "GET",
		error : function(jqxhr, status, errorMsg){
			alert("실패");
			console.log(jqxhr);
