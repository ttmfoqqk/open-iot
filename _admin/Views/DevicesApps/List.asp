									...
									<div class="panel-body">
										...
										<input type="hidden" name="action" value="<%=action%>">
											...
											<div class="form-group col-lg-12 col-md-12">
												...
												<label class="col-lg-2 col-md-2 control-label" for=""><%=ViewData("PageName")%>명</label>
												<div class="col-lg-3 col-md-3">
													<input type="text" class="form-control" id="name" name="name" placeholder="<%=ViewData("PageName")%>명" value="">
												</div>
											...
											<table class="table table-bordered" id="tabletools">
												<thead>
													<tr>
														...
														<th><%=ViewData("PageName")%>명</th>
														<th class="per20">등록자</th>
														<th class="per15">등록일</th>
													</tr>
												</thead>
												<tbody>
