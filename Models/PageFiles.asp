...
class PageFiles
	...
	public property get ParentName()
		ParentName = mParentName
	end property
	public property let ParentName(val)
		mParentName = val
	end property
...
class PageFilesHelper
	...
	private sub Class_Initialize()
		selectSQL = " SELECT * FROM [PageFiles] "
	end sub
	...
	public function Insert(ByRef obj)
		...
		strSQL= " Insert into [PageFiles] (ParentName,Name)" & _
		" Values (?,?); " & _
		...
		if DbAddParameters(objCommand, Array(obj.ParentName,obj.Name)) then
	...
	public function SelectByField(fieldName, value)
 	...
 	public function Delete(No)
		Dim strSQL
		strSQL= "DELETE FROM [PageFiles] WHERE No = ? "
