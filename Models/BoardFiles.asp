...
class BoardFilesHelper

	Dim selectSQL

	private sub Class_Initialize()
		selectSQL = " SELECT * FROM [BoardFiles] "
	end sub
	...
	public function Insert(ByRef obj)
		...
		strSQL= " Insert into [BoardFiles] (ParentNo,Name)" & _
		" Values (?,?); " & _
	...
	public function SelectByField(fieldName, value)
 	...
 	public function Delete(No)
		Dim strSQL
		strSQL= "DELETE FROM [BoardFiles] WHERE No = ? "
