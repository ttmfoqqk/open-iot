...
class DevicesAppsBoardFilesHelper

	Dim selectSQL

	private sub Class_Initialize()
		selectSQL = " SELECT * FROM [DevicesAppsBoardFiles] "
	end sub
	...
	public function Insert(ByRef obj)
		...
		strSQL= " Insert into [DevicesAppsBoardFiles] (ParentNo,Name)" & _
		" Values (?,?); " & _
	...
	public function SelectByField(fieldName, value)
 	...
 	public function Delete(No)
		Dim strSQL
		strSQL= "DELETE FROM [DevicesAppsBoardFiles] WHERE No = ? "
	...
	private function PopulateObjectFromRecord(record)
		if record.eof then 
			...
			Dim obj
			set obj = new DevicesAppsBoardFiles
			obj.No        = record("No")
