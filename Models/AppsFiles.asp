...
class AppsFilesHelper

	Dim selectSQL

	private sub Class_Initialize()
		selectSQL = " SELECT * FROM [AppsFiles] "
	end sub
	...
	public function Insert(ByRef obj)
		...
		strSQL= " Insert into [AppsFiles] (ParentNo,Name)" & _
		" Values (?,?); " & _
	...
	public function SelectByField(fieldName, value)
 	...
 	public function Delete(No)
		Dim strSQL
		strSQL= "DELETE FROM [AppsFiles] WHERE No = ? "
