<div class="max_width_wrap">
	...
	<div class="sub_contents_full">
		<div class="inner">
			<h2 class="sub_title_black">Apps Update</h2>
			...
			<div class="Detail_full">
				...
				<div class="area_registe">
					...
					<table class="form">
						...
						<tr>
							...
							<td>
								<div class="upload_img">
									<div class="mask">
										<img class="trick"><img src="<%=iif(IsNothing(Model.ImagesList) or Model.ImagesList="","/images/bg_no_image.png","/upload/Apps/" &Model.ImagesList)%>" class="images">
									</div>
						...
						<tr>
							...
							<td>
								...
								<div class="upload_img">
									<div class="mask">
										<img class="trick"><img src="<%=iif(IsNothing(Model.Images1) or Model.Images1="","/images/bg_no_image.png","/upload/Apps/" &Model.Images1)%>" class="images">
									</div>
								...
								<div class="upload_img">
									<div class="mask">
										<img class="trick"><img src="<%=iif(IsNothing(Model.Images2) or Model.Images2="","/images/bg_no_image.png","/upload/Apps/" &Model.Images2)%>" class="images">
									</div>
								...
								<div class="upload_img">
									<div class="mask">
										<img class="trick"><img src="<%=iif(IsNothing(Model.Images3) or Model.Images3="","/images/bg_no_image.png","/upload/Apps/" &Model.Images3)%>" class="images">
									</div>
								...
								<div class="upload_img no_margin">
									<div class="mask">
										<img class="trick"><img src="<%=iif(IsNothing(Model.Images4) or Model.Images4="","/images/bg_no_image.png","/upload/Apps/" &Model.Images4)%>" class="images">
									</div>
									<label class="files" style="margin:0px;padding:0px;">
										사진등록
						...
						<tr>
							...
							<td>
								...
								<div style="margin-bottom:10px;">
									<span style="margin-right:10px;"><a href="/Utils/download.asp?pach=/upload/Apps/&file=<%=files.Name%>"><%=files.Name%></a></span>
					...
					<div style="text-align:right;">
						<button class="white" type="button" onclick="reg_fm()">어플리케이션 등록</button>
					</div>
				</div>
...
function reg_fm(){
	...
	if( (!$('#images_files1').val() && !$('#images_files1_old').val()) && (!$('#images_files2').val() && !$('#images_files2_old').val()) && (!$('#images_files3').val() && !$('#images_files3_old').val()) && (!$('#images_files4').val() && !$('#images_files4_old').val()) ){
		alert('어플리케이션 상세 이미지를 선택해주세요');return false;
	}
...
function call_relation(obj){
	...
	$.ajax({
		url : "?controller=DevicesApps&action=AjaxDevicesList&MenuNo="+menuNo+"&partial=True",
		type : "GET",
