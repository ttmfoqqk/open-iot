		...
		<div class="max_width_wrap">
			...
			<nav>
				<ul>
					...
					<li class="item item2"><a class="<%=iif(controller = "DeveloperSupport","active","")%>" href="?controller=DeveloperSupport&action=Device">Developer Support</a></li>
					<li class="item item3"><a class="<%=iif(controller = "DevicesApps","active","")%>" href="?controller=DevicesApps&action=DevicesList">Devices&Services</a></li>
